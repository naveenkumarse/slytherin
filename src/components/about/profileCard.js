...
const ProfileCard = (props) => {
    ...
    <div
        className="relative font-mono flex flex-col md:flex-row md:space-x-4 space-y-2 md:space-y-0 rounded-sm shadow-lg p-2 max-w-xs md:max-w-2xl mx-auto border border-white bg-white">
